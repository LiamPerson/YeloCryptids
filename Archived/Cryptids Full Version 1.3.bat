@ echo off
color 0f
Title YeloCryptids by YeloPartyHat© Official Version 1.3
...
echo Mana   %mp%/%mpm%                  YeloCryptids 1.3               MPotions %mpots%
echo.
...
if "%agquest%" equ "1" echo AF August's Forge
echo 0 Awards
echo I Inventory
echo E Exit
...
if %input% equ m goto membershoptest
...
set /a stone=%stone%+1
set /a exp=%exp%+5
set /a temp501=%random% %% 5
set /a temp502=%random% %% 107
set /a temp503=%random% %% 331
