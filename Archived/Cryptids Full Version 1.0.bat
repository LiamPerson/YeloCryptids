...
:startgamecryptids
cls
echo Type T to play the Trial Version
echo Type F to play the Full Game
echo.
echo.
echo.
echo.
...
echo.
set input=3
set /p input=Game Mode:
if %input% equ f goto keycode
if %input% equ t goto trial
goto startgamecryptids
...
echo You lost %explossdeath%Experience
echo You lost %goldlossdeath%Gold
...
echo Mana   %mp%/%mpm%               Version Beta 1.3                  MPotions %mpots%
echo.
...
echo 6 Mining
echo 7 Woodcutting
if "%temp5%" equ "1" echo 8 Blood Path
if "%temp7%" equ "1" echo 9 Forgoten Forest
echo 0 Awards
echo I Inventory
echo E Exit
...
if %input% equ 8 goto bptest
if %input% equ 9 goto fftest
...
:lrsell
cls
if %lether% lss 1 goto sellcsupplier
set /a leather=%leather%-1
set /a gold=%gold%+21
goto sellcsupplier
...
if "%armor3%" gtr "0" (
	echo     IM                     Iron Mask          72 Gold           %armor3%
)
if "%armor15%" gtr "0" (
...
if "%armor4%" gtr "0" (
	echo     IH                     Iron Helmet        169 Gold          %armor4%
)
if "%armor16%" gtr "0" (
...
if "%armor5%" gtr "0" (
	echo     GIH                    GIron Helmet       479 Gold          %armor5%
)
if "%armor17%" gtr "0" (
...
if %input% equ im goto imsell
if %input% equ ih goto ihsell
if %input% equ il goto ilsell
if %input% equ ipl goto iplsell
if %input% equ gih goto gihsell
...
echo Whatcha Buying?
echo Type the Abriviation to buy it...
echo Gold=%gold%                Type B To go back to the Appocathy
echo _____________________________________________________________
echo Abriviation        Name         Price            Boost
echo.
echo    HP          Health Potion   25 Gold     Restores 50 Health
echo.
echo    MP           Mana Potion    20 Gold     Restores 60 Mana
echo.
echo.
echo.
set input=7
...
set /a healingprice=(%hpm%-%hp%)*10
echo Restoring Health cost %healingprice%Gold, although you'll be fully healed...
...
:healer2
if %gold% lss %healingprice goto notappocathy
set /a hp=%hpm%
set /a gold=%gold%-%healingprice%
goto healingplayer
...
set /a restoremanaprice=(%hpm%-%hp%)*5
echo Restoring Mana cost %restoremanaprice%old, although you'll recover fully
echo Are you sure? y-n
set input=4
set /p input=...
...
:priest2
if %gold% lss %restoremanaprice% goto notappocathy
set /a mp=%mpm%
set /a gold=%gold%-%restoremanaprice%
goto renewingplayer
...
(echo silver=%silver%)>> CPT%name%SAV.dll
(echo armorcopper3=%armorcopper3%)>> CPT%name%SAV.dll
(echo armorcopper1=%armorcopper1%)>> CPT%name%SAV.dll
(echo armorcopper2=%armorcopper2%)>> CPT%name%SAV.dll
(echo warmorcopper3=%warmorcopper3%)>> CPT%name%SAV.dll
(echo warmorcopper1=%warmorcopper1%)>> CPT%name%SAV.dll
(echo warmorcopper2=%warmorcopper2%)>> CPT%name%SAV.dll
...
(echo armor12=%armor12%)>> CPT%name%SAV.dll
(echo armor13=%armor13%)>> CPT%name%SAV.dll
(echo armor14=%armor14%)>> CPT%name%SAV.dll
(echo armor15=%armor15%)>> CPT%name%SAV.dll
(echo armor16=%armor16%)>> CPT%name%SAV.dll
(echo armor17=%armor17%)>> CPT%name%SAV.dll
...
(echo warmor12=%warmor12%)>> CPT%name%SAV.dll
(echo warmor13=%warmor13%)>> CPT%name%SAV.dll
(echo warmor14=%warmor14%)>> CPT%name%SAV.dll
(echo warmor15=%warmor15%)>> CPT%name%SAV.dll
(echo warmor16=%warmor16%)>> CPT%name%SAV.dll
(echo warmor17=%warmor17%)>> CPT%name%SAV.dll
(echo warmorcopper1=%warmorcopper1%)>> CPT%name%SAV.dll
(echo warmorcopper2=%warmorcopper2%)>> CPT%name%SAV.dll
(echo warmorcopper3=%warmorcopper3%)>> CPT%name%SAV.dll
(echo wornarmor0=%wornarmor0%)>> CPT%name%SAV.dll
(echo wornarmor1=%wornarmor1%)>> CPT%name%SAV.dll
(echo wornarmor2=%wornarmor2%)>> CPT%name%SAV.dll
:stats
cls
color 1d
echo %name% %lvl%
...
cls
color 0f
echo       This is the Trial Version of Cryptids
echo       You may give this game away as you wish
echo             If you payed for this trial
echo dammand a refund from whomever you had bought it from
echo         Full version includes ANIMATIONS!
echo                 More Monsters
echo                  More Bosses
echo                  More Quests
echo         Access To Many things such as
echo               The Creation Room
echo                   Inventory
echo                     Armor
echo                 Woodcutting
echo                    Mining
echo              AND MUCH MUCH MORE!!!
echo Buy the full game at http://yelocryptids.webs.com/
echo          Buy it now while its only $1
echo.
echo.
pause >nul
goto newtrial
...
set /a mpm=%lvl%*100
set /a hit=%power%+%weappower%+%weaptype%
if %exp% geq %exptill% goto leveluptrial
cls
echo CRYPTIDS TRIAL %lvl%		         Expierence %exp%/%exptill%       Defence DISABLED
echo Health %hp%/%hpm%			Gold %gold%			  HPotions %pots%
echo Mana   %mp%/%mpm%              Trial Version 1.7                  MPotions %mpots%
echo.
echo Where you want to go?
echo.
echo 1 Outside the Village
...
set input=15
set /p input=...
if %input% equ 1 goto outtrial
if %input% equ 2 goto shoptrial
if %input% equ 3 goto healertrial
if %input% equ 4 goto priesttrial
if %input% equ 5 goto trainingtrial
if %input% equ 6 goto towertrial
if %input% equ 7 goto arenatrial
if %input% equ 8 goto miningtrial
if %input% equ 9 goto woodcuttingtrial
if %input% equ 10 goto bptesttrial
if %input% equ 0 goto awardstrial
if %input% equ 1234567890qwertyuiopasdfghjklzxcvbnm goto haxtrial
if %input% equ BillGates goto ghaxtrial
if %input% equ e exittrial
if %input% equ s goto savetrial
if %input% equ i goto invintrial
if %input% equ c goto craftingtrial
goto hometrial
...
set input=6
set /p input=...
if %input% equ 1 goto upgradetrial
if %input% equ 2 goto buypottrial
if %input% equ 3 goto buympottrial
if %input% equ 4 goto hometrial
goto shoptrial

:upgradetrial
if %gold% lss %weapprice% goto nottrial
set /a gold=%gold% - %weapprice%
set /a weapprice=%weapprice% + 100
set /a weappower=%weappower% + 2
cls
...
echo.
echo For animations buy the full version at http://yelocryptids.webs.com/
ping localhost -n 2 >nul
cls
...
set input=7
set /p input=...
if %input% equ 1 goto bp1trial
if %input% equ 2 goto bp2trial
if %input% equ 3 goto bp3trial
if %input% equ 4 goto bp4trial
if %input% equ 5 goto bp5trial
goto buypottrial
...
set input=7
set /p input=...
if %input% equ 1 goto mbp1trial
if %input% equ 2 goto mbp2trial
if %input% equ 3 goto mbp3trial
if %input% equ 4 goto mbp4trial
if %input% equ 5 goto mbp5trial
goto buympottrial
...
set input=4
set /p input=...
if %input% equ y goto healer2trial
if %input% equ n goto hometrial
goto healertrial

:healer2trial
if %gold% lss 10 goto not2trial
set /a hp=%lvl% * 50
set /a gold=%gold% - 10
goto healingplayertrial
...
set input=4
set /p input=...
if %input% equ y goto priest2trial
if %input% equ n goto hometrial
goto priesttrial
...
:savetrial
cls
echo Saving has been disabled in the trial version
echo go to http://yelocryptids.webs.com/ to purchase the full version
pause >nul
goto hometrial
...
:craftingtrial
cls
echo                The Creation Room has been disabled in the trial version
echo      Wood=%wood%  Elvetched=%elv%  Iron=%iron%  Gold Ore=%gore%  YeloTitanOre=%yto%
echo     Stone=%stone% Herbs=%herbs%  Flowers=%flowers%  Leather=%leather% Silver=%silver%
echo ____________________________________________________________________________
echo    Abriviation            Item                Reqirements              Boost
...
:invintrial
cls
echo You cannot access the inventory in the trial version
echo go to http://yelocryptids.webs.com/ to buy the full version
pause >nul
goto hometrial
...
:woodcuttingtrial
cls
echo Woodcutting has been disabled in the trial version
echo go to http://yelocryptids.webs.com/ to buy the full version
pause >nul
goto hometrial
...
:miningtrial
cls
echo Mining has been disabled in the trial version
echo go to http://yelocryptids.webs.com/ to buy the full version
pause >nul
goto hometrial
...
:arenatrial
echo The Arena is Only avaliable in
echo the full version buy it now at
echo http://yelocryptids.webs.com/
pause >nul
goto hometrial
::   #   ENEMY 1  ##########################################################################
...
set input=7
set /p input=...
if %input% equ 1 goto attackgoblintrial
if %input% equ 2 goto specgoblintrial
if %input% equ 3 goto drinkpotgoblintrial
if %input% equ 4 goto drinkmpotgoblintrial
if %input% equ 5 goto runawaytrial
goto fightgoblintrial
...
set /a en1hp=%en1hp% - (%hit% * 2)
set /a mp=%mp% - 100
if %en1hp% leq 0 goto killedgoblintrial
if %def% geq %en1hit% goto fightgoblintrial
set /a hp=%hp% - (4-%def%)
if %hp% leq 0 goto deathtrial
goto fightgoblintrial
...
set input=5
set /p input=...
if %input% equ 1 goto out3trial
if %input% equ 2 goto outtrial
if %input% equ 3 goto hometrial
goto out2trial
...
set input=7
set /p input=...
if %input% equ 1 goto attackskeletontrial
if %input% equ 2 goto specskeletontrial
if %input% equ 3 goto drinkpotskeletontrial
if %input% equ 4 goto drinkmpotskeletontrial
if %input% equ 5 goto runawaytrial
goto fightskeletontrial
...
set /a en2hp=%en2hp% - (%hit% * 2)
set /a mp=%mp% - 100
if %en2hp% leq 0 goto killedskeletontrial
if %def% geq %en2hit% goto fightskeletontrial
set /a hp=%hp% - (11-%def%)
if %hp% leq 0 goto deathtrial
goto fightskeletontrial
...
set /a en2hp=%en2hp% - %hit%
if %en2hp% leq 0 goto killedskeletontrial
if %def% geq 11 goto fightskeletontrial
set /a hp=%hp% - (11-%def%)
if %hp% leq 0 goto deathtrial
goto fightskeletontrial

:drinkpotskeletontrial
if %pots% lss 1 (
    echo You don't have any potions...
	pause >nul
	goto fightskeletontrial
...
set input=5
set /p input=...
if %input% equ 1 goto out5trial
if %input% equ 2 goto out3trial
if %input% equ 3 goto outtrial
goto out4trial
...
set input=7
set /p input=...
if %input% equ 1 goto attackzombietrial
if %input% equ 2 goto speczombietrial
if %input% equ 3 goto drinkpotzombietrial
if %input% equ 4 goto drinkmpotzombietrial
if %input% equ 5 goto runawaytrial
goto fightzombietrial
...
set /a en3hp=%en3hp% - (%hit% * 2)
set /a mp=%mp% - 100
if %en3hp% leq 0 goto killedzombietrial
if %def% geq %en3hit% goto fightzombietrial
set /a hp=%hp% - (28-%def%)
if %hp% leq 0 goto deathtrial
goto fightzombietrial
...
set input=5
set /p input=...
if %input% equ 1 goto out7trial
if %input% equ 2 goto out5trial
if %input% equ 3 goto out3trial
goto out6trial
...
set input=7
set /p input=...
if %input% equ 1 goto attackgspidertrial
if %input% equ 2 goto specgspidertrial
if %input% equ 3 goto drinkpotgspidertrial
if %input% equ 4 goto drinkmpotgspidertrial
if %input% equ 5 goto runawaytrial
goto fightgspidertrial
...
set /a gspiderhp=%gspiderhp% - (%hit% * 2)
set /a mp=%mp% - 100
if %gspiderhp% leq 0 goto killedgspidertrial
if %def% geq %en4hit% goto fightgpsidertrial
set /a hp=%hp% - (50-%def%)
if %hp% leq 0 goto deathtrial
goto fightgspidertrial
...
set /a gspiderhp=%gspiderhp% - %hit%
if %gspiderhp% leq 0 goto killedgspidertrial
if %def% geq %en4hit% goto fightgspidertrial
set /a hp=%hp% - (50-%def%)
if %hp% leq 0 goto deathtrial
goto fightgspidertrial

:drinkpotgspidertrial
if %pots% lss 1 (
    echo You don't have any potions...
	pause >nul
	goto fightgspidertrial
...
set input=5
set /p input=...
if %input% equ 1 goto out9trial
if %input% equ 2 goto out7trial
if %input% equ 3 goto out5trial
goto out8
...
set input=7
set /p input=...
if %input% equ 1 goto attackgod1trial
if %input% equ 2 goto specgod1trial
if %input% equ 3 goto drinkpotgod1trial
if %input% equ 4 goto drinkmpotgod1trial
if %input% equ 5 goto runawaytrial
goto fightgod1trial
...
set /a god1hp=%god1hp% - (%hit% * 2)
set /a mp=%mp% - 100
if %god1hp% leq 0 goto killedgod1trial
if %def% geq 150 goto fightgod1trial
set /a hp=%hp% - (150-%def%)
if %hp% leq 0 goto deathtrial
goto fightgod1trial
...
set input=5
set /p input=...
if %input% equ 1 goto out11trial
if %input% equ 2 goto out9trial
if %input% equ 3 goto out7trial
goto out10trial
...
set input=7
set /p input=...
if %input% equ 1 goto attacksep1trial
if %input% equ 2 goto specsep1trial
if %input% equ 3 goto drinkpotsep1trial
if %input% equ 4 goto drinkmpotsep1trial
if %input% equ 5 goto runawaytrial
goto fightsep1trial
...
set /a sep1hp=%sep1hp% - (%hit% * 2)
set /a mp=%mp% - 100
if %sep1hp% leq 0 goto killedsep1trial
if %def% geq 200 goto fightsep1trial
set /a hp=%hp% - (200-%def%)
if %hp% leq 0 goto deathtrial
goto fightsep1trial
...
set input=5
set /p input=...
if %input% equ 1 goto gskele1trial
if %input% equ 2 goto out13trial
if %input% equ 3 goto tpsep1trial
goto pt2mgtrial
...
set input=7
set /p input=...
if %input% equ 1 goto attackknttrial
if %input% equ 2 goto specknttrial
if %input% equ 3 goto drinkpotknttrial
if %input% equ 4 goto drinkmpotknttrial
if %input% equ 5 goto runawaytrial
goto fightknttrial
...
set /a knthp=%knthp% - (%hit% * 2)
set /a mp=%mp% - 100
if %knthp% leq 0 goto killedknttrial
if %def% geq 220 goto fightknttrial
set /a hp=%hp% - (220-%def%)
if %hp% leq 0 goto deathtrial
goto fightknttrial
...
set input=5
set /p input=...
if %input% equ 1 goto archer1trial
if %input% equ 2 savelifeknttrial
if %input% equ 3 goto tpknttrial
goto out14trial
...
set archerhp=1500
cls
echo You have been attacked by a Archer!
pause >nul
goto fightarchertrial
...
set input=7
set /p input=...
if %input% equ 1 goto attackarchertrial
if %input% equ 2 goto specarchertrial
if %input% equ 3 goto drinkpotarchertrial
if %input% equ 4 goto drinkmpotarchertrial
if %input% equ 5 goto runawaytrial
goto fightarchertrial
...
set /a archerhp=%archerhp% - (%hit% * 2)
set /a mp=%mp% - 100
if %archerhp% leq 0 goto killedarchertrial
if %def% geq 150 goto fightarchertrial
set /a hp=%hp% - (150-%def%)
if %hp% leq 0 goto deathtrial
goto fightarchertrial
...
set input=5
set /p input=...
if %input% equ 1 goto scout1trial
if %input% equ 2 goto archer1trial
if %input% equ 3 goto tparchertrial
goto good1trial
...
set input=7
set /p input=...
if %input% equ 1 goto attackgskeletrial
if %input% equ 2 goto specgskeletrial
if %input% equ 3 goto drinkpotgskeletrial
if %input% equ 4 goto drinkmpotgskeletrial
if %input% equ 5 goto runawaytrial
goto fightscouttrial
...
set /a gskelehp=%gskelehp% - (%hit% * 2)
set /a mp=%mp% - 100
if %gskelehp% leq 0 goto killedgskeletrial
if %def% geq 136 goto fightgskeletrial
set /a hp=%hp% - (136-%def%)
if %hp% leq 0 goto deathtrial
goto fightgskeletrial
...
set /a darkwhp=%darkwhp% - (%hit% * 2)
set /a mp=%mp% - 100
if %darkwhp% leq 0 goto killeddarkwtrial
if %def% geq 157 goto fightdarkwtrial
set /a hp=%hp% - (157-%def%)
if %hp% leq 0 goto deathtrial
goto fightdarkwtrial
...
set input=5
set /p input=...
if %input% equ 1 goto aprenttrial
if %input% equ 2 goto darkwtrial
if %input% equ 3 goto tpdarkwtrial
goto bad2trial
...
set aprenthp=1750
cls
echo You have been attacked by a Apprentice of Necromancers!
pause >nul
goto fightaprenttrial
...
set input=7
set /p input=...
if %input% equ 1 goto attackaprenttrial
if %input% equ 2 goto specaprenttrial
if %input% equ 3 goto drinkpotaprenttrial
if %input% equ 4 goto drinkmpotaprenttrial
if %input% equ 5 goto runawaytrial
goto fightaprenttrial
...
set /a aprenthp=%aprenthp% - (%hit% * 2)
set /a mp=%mp% - 100
if %aprenthp% leq 0 goto killedaprenttrial
if %def% geq 180 goto fightaprenttrial
set /a hp=%hp% - (180-%def%)
if %hp% leq 0 goto deathtrial
goto fightaprenttrial
...
set input=5
set /p input=...
if %input% equ 1 goto bones1trial
if %input% equ 2 goto aprenttrial
if %input% equ 3 goto tpaprenttrial
goto bad3
...
set input=7
set /p input=...
if %input% equ 1 goto attackscouttrial
if %input% equ 2 goto specscouttrial
if %input% equ 3 goto drinkpotscouttrial
if %input% equ 4 goto drinkmpotscouttrial
if %input% equ 5 goto runawaytrial
goto fightscouttrial
...
set /a scouthp=%scouthp% - %hit%
set /a mp=%mp% - 100
if %scouthp% leq 0 goto killedscouttrial
if %def% geq 127 goto fightscouttrial
set /a hp=%hp% - (127-%def%)
if %hp% leq 0 goto deathtrial
goto fightscouttrial
...
cls
set /a scouthp=%scouthp% - (%power% + %weappower%)
if %archerhp% leq 0 goto killedscouttrial
if %def% geq 127 goto fightscouttrial
set /a hp=%hp% - (127-%def%)
if %hp% leq 0 goto deathtrial
goto fightscouttrial
...
set /p input=...
if %input% equ 1 goto bones1trial
if %input% equ 2 goto scout1trial
if %input% equ 3 goto tpscouttrial
goto good2trial
...
set input=7
set /p input=...
if %input% equ 1 goto attackbonestrial
if %input% equ 2 goto specbonestrial
if %input% equ 3 goto drinkpotbonestrial
if %input% equ 4 goto drinkmpotbonestrial
if %input% equ 5 goto runawaytrial
goto fightbonestrial
...
set /a boneshp=%boneshp% - (%hit% * 2)
set /a mp=%mp% - 100
if %boneshp% leq 0 goto killedbonestrial
if %def% geq 254 goto fightbonestrial
set /a hp=%hp% - (254-%def%)
if %hp% leq 0 goto deathtrial
goto fightbonestrial
...
set input=5
set /p input=...
if %input% equ 1 goto bonesfingtrial
if %input% equ 2 goto bonesfinwtrial
if %input% equ 3 goto bonesfinttrial
goto bonestrophtrial
...
:bpe1trial
echo To access More Quests Buy the Full Version
echo.
echo             Full Version Quest Features
echo Over 4 new Quests and more than 60 monsters and bosses!
echo    Buy it now at http://yelocryptids.webs.com/
pause >nul
goto hometrial
...
::HAX########################
:haxtrial
echo CHEATS HAVE DISABLED IN THE TRIAL VERSION
pause >nul
goto hometrial
...
:awardstrial
cls
echo    Awards are not avaliable in the cryptids trial
echo to access these rewards go to http://yelocryptids.webs.com/
echo         and purchase the game for only $1!!!
pause >nul
goto hometrial