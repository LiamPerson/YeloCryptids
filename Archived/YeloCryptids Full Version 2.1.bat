@ echo off
color 0f
Title YeloCryptids by YeloPartyHat© 2012 Official Version 2.1
...
pause >nul
cls
echo Ask around the town is anyone needs any help with anything...
echo And beware outside the town if infested with evil mosters.
echo            _______                          _______
echo           /       \                        /_______\
echo          /_________\                       I 0     I
echo          I     I_I I                      /_       I
...
echo Mana   %mp%/%mpm%                  YeloCryptids 2.1               MPotions %mpots%
echo.
